...
class ResponseOptions(BaseModel):
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in set(['any', 'fair', 'regex']):
            raise ValueError("must be one of enum values ('any', 'fair', 'regex')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResponseOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResponseOptions from a dict"""
        if obj is None:
            return None
